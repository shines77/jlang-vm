...
#ifndef JLANG_STREAM_OUTPUTSTRINGSTREAM_H
#define JLANG_STREAM_OUTPUTSTRINGSTREAM_H
...
class OutputStringStream : public IInputStream<OutputStringStream>,
                           public StreamRoot {
public:
    typedef StreamRoot root_type;

    OutputStringStream() : root_type() {
    }
...
#endif // JLANG_STREAM_OUTPUTSTRINGSTREAM_H
